...
export function write_stats_page(
	...
	+             '\t\t\t<p>' + jammer_list.length.toString() + ' jammers</p>\n'
	+             '\t\t\t<p>' + get_jammer_count(jam_list, false).toString()
	                          + ' minijammers</p>\n'
	+             '\t\t\t<p>' + get_jammer_count(jam_list, true).toString()
	                          + ' majorjammers</p>\n'
	+             '\n'
	+             '\t\t\t<h3>Mini Jam</h3>\n'
	+             '\t\t\t<p>' + jam_list.filter(v => !v.is_majorjam).length
	                                                                .toString()
	                          + ' Mini Jams</p>\n'
	+             '\t\t\t<p>' + jam_list.filter(v => !v.is_majorjam)
